    ...
    <div class="container">
        <div class="row">
            <div class="col-10 text-center mx-auto col-sm-6">
                <h1 class="product-title">Products in cart</h1>
            </div>
        </div>
        ...
        <table class="table table-striped">
            ...
            <tr align="center" width="50%" border="1" >
                ...
                <td>
                    <a href="/products/buy" method="POST" ><button type="button" class="btn btn-success" >BUY</button></a>
                    <a href="/products/cart/delete" method="POST" ><button type="button" class="btn btn-danger">DELETE FROM CART</button></a>
                </td>
            </tr>
            </#list>
            </tbody>
